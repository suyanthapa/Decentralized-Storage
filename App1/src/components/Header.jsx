      ...
      <aside className="fixed top-0 left-0 w-64 h-screen bg-gray-900 text-white pt-8 z-10 flex flex-col justify-between border border-black">
        <div>
          ...
          <nav className="flex flex-col items-center space-y-4">
            ...
            <a
              href="#"
              className={`flex items-center space-x-4 hover:bg-purple-950 p-2 pl-20 rounded w-full text-center ${activeSection === 'help' ? 'bg-purple-900' : 'hover:bg-gray-700'}`}
            ...
            <a
              href="#"
              className={`flex items-center space-x-4 hover:bg-purple-950 p-2 pl-20 rounded w-full text-center ${activeSection === 'about' ? 'bg-purple-900' : 'hover:bg-gray-700'}`}
          ...
          <div className="text-white text-base flex justify-center mt-44 flex flex-col">
            ...
            {account ? (
              <button
                ...
                className="bg-red-600 py-3 rounded-md hover:bg-red-700"
              >
                Disconnect Wallet
              </button>
            ) : (
