  ...
  return (
    ...
    >
      <div className="flex flex-col justify-center items-center text-center h-screen">
        <h1 className="text-6xl font-bold mb-5 "> <span className='text-green-700'>Unlock</span> the Power of Decentralized Storage with <span className='text-purple-900'>DataBridge</span></h1>
